...
describe("ContactController", () => {
    ...
    it("should add a single contact into the book", done => {
      this.book
        ...
        .then(contact => {
          ...
          expect(conatc.email).toBe("alice@example.com");
          done();
        })
        .catch(err => {
          done();
  ...
  describe("search methods", () => {
    ...
    describe("#search()", () => {
      ...
      it("should return the contacct when found", done => {
    ...
    describe("binarySearch()", () => {
      ...
      it("should return null when called with an empty array", () => {
        expect(this.book.binarySearch([], "Alloy Rodriguez")).toBeUndefined();
      });
      ...
      it("should return null when contact is not found", done => {
        this.book.addContact(...zelda).then(() => {
          this.book
            ...
            .then(contacts => {
              expect(
                this.book.binarySearch(sort(contacts), "Alloy Rodriguez")
              ).toBeUndefined();
              done();
            })
            .catch(err => {
  ...
  describe("#delete()", () => {
    it("should not remove any contacts that do not match the ID passed", done => {
      this.book
        .addContact("Rick Deckard", "000-000-000", "null@null.com")
        .then(() => {
          this.book.getContacts().then(contacts => {
